        ...
        <div class="masthead">
            <div class="masthead-content text-white">
                <div class="container-fluid px-4 px-lg-0">
                    ...
                    <!-- to get an API token!-->
                    <button class="btn btn-primary" id="submitButton" onclick='location.href="login.php"'>Iniciar Sesion</button>
                    <button class="btn btn-primary" id="submitButton" onclick='location.href="signup.php"'>Registrarse</button>
                </div>
            </div>
        </div>
        <!-- Social Icons-->
